function callingg_transformix(file_index, dir_elestix_working, file_trans_para_1)
...
transform_command_line = [pwd, '/transformix -in ' file_index, ' -out ' dir_elestix_working ' -tp ' file_trans_para_1];
